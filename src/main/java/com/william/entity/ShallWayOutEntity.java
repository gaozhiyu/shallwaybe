...
public class ShallWayOutEntity {
	...
	public ShallWayOutEntity() {
		super();
	}

	public ShallWayOutEntity(String nickname, String dateID, String userIntID, String country, String province,
