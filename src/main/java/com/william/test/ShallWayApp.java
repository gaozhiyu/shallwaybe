...
public class ShallWayApp {
	...
	public static void main(String[] args) throws ParseException {
		...
		MSW.addShallWay("1001", "Singapore", "Jurong West", "NTU", startTime, endTime, postTime, true, true, false, false, "ONE DAY TREK", "QQ: 554163030", "The Southern Ridges: From Kent Ridge MRT to VivoCity, free to join, taking arond 3 hours, total distance:9KM.");
//		MSW.listShallWay();
