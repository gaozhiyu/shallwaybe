...
public class ProfileUpdateDTO extends CommonInput{
...
//	private Date lastAddressUpdate;  	
	...
	public ProfileUpdateDTO(String userIntID, String email, String password, String nickname, String gender,
...
//	}
	...
	public ValidationResult isValid(){
		...
		if(StringUtils.isNotBlank(email) && !FieldPassFilterUtil.validEmailAdreess(email)){
			inputValid = false;
			sb.append("\n email is not valid!");
		}
		
		if(StringUtils.isNotBlank(password) && !FieldPassFilterUtil.validPasswordLength(password)){
			inputValid = false;
			sb.append("\n password is not valid!");
		}
		
		if(StringUtils.isNotBlank(city) && !FieldPassFilterUtil.validAlphOnly(city)){
			inputValid = false;
			sb.append("\n city is not valid!");
		}
		
		if(StringUtils.isNotBlank(country) && !FieldPassFilterUtil.validAlphOnly(country)){
			inputValid = false;
			sb.append("\n country is not valid!");
		}
		
		if(StringUtils.isNotBlank(province) && !FieldPassFilterUtil.validAlphOnly(province)){
			inputValid = false;
